...
export class StoresService {
  ...
  async allSearchServices(userId:any,catId:any=0,subCatIdUser:any=0,cityId:any=0,regionId:any=0,pointFrom:any=0,pointTo:any=0,typeOfOperation:any=0,limit:any){
    return new Promise(resolve => {
      this.http.get(this.baseUrl+'/'+"allSearchServices/"+userId+"/"+catId+"/"+subCatIdUser+"/"+cityId+"/"+regionId+"/"+pointFrom+"/"+pointTo+"/"+typeOfOperation+"/"+limit).subscribe(data => {
        return this.result = resolve(data);
      }, err => {
        console.log(err);
      });
