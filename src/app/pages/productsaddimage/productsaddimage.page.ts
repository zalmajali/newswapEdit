...
export class ProductsaddimagePage implements OnInit {
  ...
  uploadeFirstFile(){
    if(this.platform.is('ios') || this.platform.is('ipad') || this.platform.is('iphone')){
      ...
      this.imagePicker.getPictures(options).then((results) => {
        this.image1Replase = 'data:image/jpeg;base64,' + results[0];
  ...
  uploadeSecondFile(){
    if(this.platform.is('ios') || this.platform.is('ipad') || this.platform.is('iphone')){
      ...
      this.imagePicker.getPictures(options).then((results) => {
        this.image2Replase = 'data:image/jpeg;base64,' + results[0];
  ...
  uploadeThirdFile(){
    if(this.platform.is('ios') || this.platform.is('ipad') || this.platform.is('iphone')){
      ...
      this.imagePicker.getPictures(options).then((results) => {
        this.image3Replase = 'data:image/jpeg;base64,' + results[0];
