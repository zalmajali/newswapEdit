...
export class SearchoutPage implements OnInit {
  ...
  async functionGetData(userId:any,catId:any=0,subCatIdUser:any=0,cityId:any=0,regionId:any=0,pointFrom:any=0,pointTo:any=0,typeOfOperation:any){
    ...
    this.storesService.allSearchServices(userId,catId,subCatIdUser,cityId,regionId,pointFrom,pointTo,typeOfOperation,limitNew).then(async data=>{
      ...
      this.functionGetData(userId,catId,subCatIdUser,cityId,regionId,pointFrom,pointTo,typeOfOperation)
    });
  }
  async ngOnInit() {
    ...
    this.functionGetData(this.userId,this.catIdUser,this.subCatIdUser,this.cityId,this.regionId,this.pointFrom,this.pointTo,this.typeOfOperation)
  }
